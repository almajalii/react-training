        ...
        <div className="bg-page-2 border-b border-line py-10 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex gap-6 items-start">
                    ...
                    {/* Avatar */}
                    <div className={`w-24 h-24 rounded-2xl flex items-center justify-center font-bold text-2xl shrink-0 overflow-hidden ${toneClass}`}>
                        {pro.profileImageUrl
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-muted mt-1">{t('pro_professional') ?? 'Professional'} {pro.category}</p>

...
import {RATING_OPTIONS,DISTANCE_OPTIONS,EXPERIENCE_OPTIONS} from '../../../screens/browse/browseFiltersConstants';
import { useBrowseFilters } from './useBrowseFilters';

export default function BrowseFilters({ categorySlug, filters, onChange }) {
    const { t, CATEGORIES, toggle, reset, hasActiveFilter, goToCategory } =
        useBrowseFilters(filters, onChange, categorySlug);

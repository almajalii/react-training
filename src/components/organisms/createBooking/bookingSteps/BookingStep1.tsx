...
import type { BookingPro, BookingFormValues, BookingProService } from '../../../../types/booking'
        ...
        {pro.services?.map(svc => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`font-mono text-[13px] font-semibold shrink-0 ml-3 ${active ? 'text-brand' : 'text-ok'}`}
              >
                {priceStr}
              </div>
            </button>

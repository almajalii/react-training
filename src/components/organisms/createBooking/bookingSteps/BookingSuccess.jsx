...
export default function BookingSuccess({ pro, navigate, t }) {
  return (
    <div
    ...
    >
      ...
      <h2 className="text-[28px] font-extrabold text-ink tracking-tight mb-3">
      ...
      <div className="flex gap-3 justify-center">
        ...
        <button
          ...
          className={`${gfx.btnSecondary} px-6 h-11 text-[15px]`}
        >

...
import type { BookingFormValues, SavedAddress, DateSlot } from '../../../../types/booking'

interface BookingStep2Props {
  formik: FormikProps<BookingFormValues>
  selectDate: (date: DateSlot) => void
  selectTime: (time: string) => void
  selectAddress: (address: SavedAddress) => void
  savedAddresses: SavedAddress[]
  dateSlots: DateSlot[]
  isDayUnavailable: (date: DateSlot) => boolean

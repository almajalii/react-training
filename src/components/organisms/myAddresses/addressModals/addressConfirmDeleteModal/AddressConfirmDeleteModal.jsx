...
export default function AddressConfirmDeleteModal({ address, t, onCancel, onConfirm, isDeleting }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-extrabold text-ink tracking-tight mb-2">{t('addr_delete_title')}</h2>
        ...
        <div className="flex items-center justify-end gap-3 mt-6">
          <Button type="button" onClick={onCancel} className={`${gfx.btnSecondary} px-5 h-11 cursor-pointer`}>
            {t('addr_keep')}
          </Button>
          <Button
            type="button"

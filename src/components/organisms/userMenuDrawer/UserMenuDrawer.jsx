  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden sm:block text-[15px] font-medium text-ink">{user?.firstName}</span>
        <ChevronDown
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="py-2 px-2">
            ...
            <MenuItem
              icon={Bell}
              label={t('menu_notification_settings')}
              to="/notification-settings"
              onClick={close}
            />
            <MenuItem
              icon={User}
              label={t('menu_personal_information')}
              to="/profile"
              onClick={close}
            />
            ...
            <button
              ...
              className="flex items-center gap-3 w-full rounded-xl px-3 py-2.5 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors cursor-pointer"
            >

  ...
  return (
    <div className={`${gfx.cardLg} px-8 py-10`}>
      ...
      <form onSubmit={formik.handleSubmit}>
        <FormRow>
          <FormField label={t('firstName')} name="firstName" placeholder="Ahmad"
          ...
          <FormField label={t('lastName')} name="lastName" placeholder="Khalil"
        ...
        <FormField label={t('phone')} name="phone" type="tel" placeholder="+962791234567"
        ...
        <FormRow>
          ...
          <FormField label={t('confirm_password')} name="confirmPassword" type="password" placeholder="••••••••"
      ...
      <p className="text-center text-sm text-muted mt-6">
        ...
        <Link to="/login" className="text-ink font-semibold hover:underline">{t('sign_in')}</Link>
      </p>
    </div>
  );
}
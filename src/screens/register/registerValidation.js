...
export const registerValidationSchema = (t) =>
  Yup.object({
    firstName: Yup.string().min(2, t('val_firstName_min')).required(t('val_firstName_required')),
    lastName: Yup.string().min(2, t('val_lastName_min')).required(t('val_lastName_required')),
    ...
    password: Yup.string()
      ...
      .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])/, t('val_password_weak'))

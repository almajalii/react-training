import {
  Wrench, Zap, Snowflake, Hammer,
  Paintbrush2, SprayCan, PackageOpen, Plug,
} from 'lucide-react';
...
export const CATEGORIES = [
  ...
  { slug: 'electrical', Icon: Zap,         nameKey: 'category_electrical', subKey: 'category_electrical_sub' },
  { slug: 'ac',         Icon: Snowflake,   nameKey: 'category_ac',         subKey: 'category_ac_sub'         },
  { slug: 'carpentry',  Icon: Hammer,      nameKey: 'category_carpentry',  subKey: 'category_carpentry_sub'  },
  { slug: 'painting',   Icon: Paintbrush2, nameKey: 'category_painting',   subKey: 'category_painting_sub'   },
  { slug: 'cleaning',   Icon: SprayCan,    nameKey: 'category_cleaning',   subKey: 'category_cleaning_sub'   },
  { slug: 'moving',     Icon: PackageOpen, nameKey: 'category_moving',     subKey: 'category_moving_sub'     },
  { slug: 'appliance',  Icon: Plug,        nameKey: 'category_appliance',  subKey: 'category_appliance_sub'  },
];

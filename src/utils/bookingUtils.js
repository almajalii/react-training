...
import { FULL_DAY_NAMES } from '../constants/days'; // ← now actually used
...
export function buildDateSlots(isAr) {
...
export function isWithinWorkingHours(timeSlot, openTime, closeTime) {
